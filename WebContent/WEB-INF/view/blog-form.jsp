                ...
                <div class="card-body">
                  <div class="row">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                        <label>Time</label>
                        <form:input type="text" class="form-control" placeholder="Enter time of creation" path="time"/>
                        
                      </div>
                       <div class="form-group">
                        <label>Text</label>
                        <form:textarea  class="form-control" placeholder="Enter Blog Text" path="text"/>
                      </div>
                      ...
                      <form:select path="tags" items="${tagList}" itemLabel="name" itemValue="id" multiple="true" class="form-control"></form:select>
                         ...
                         <div class="custom-control custom-checkbox">
                          ...
                          <label for="customCheckbox2" class="custom-control-label">Show on recent blog menu</label>
                        </div>
